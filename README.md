...
* multiplePickpocketAttempts - allow you to pickpocket an NPC even if they have already caught you once before ("Already Caught Pickpocketing" from Scrambled Bugs)
