...
namespace Patch
{
    ...
    private:
        ...
        static RE::BSContainer::ForEachResult FunctionCallOperator(void* findMaxMagnitudeVisitor, RE::ActiveEffect* activeEffect); // Replace with above line when RE is done on FindMaxMagnitudeVisitor
